      ...
      <div className="section min-h-screen">
        <div className="max-w-7xl mx-auto">
          ...
          <header className="mb-12 text-center">
            ...
            {/* Billing toggle */}
            <div className="inline-flex items-center gap-3 p-1 border border-terminal-border rounded-md bg-terminal-gray/30">
              <button
                onClick={() => setAnnual(false)}
                className={`px-5 py-2 rounded-md font-mono text-sm transition-colors ${
                  !annual
              ...
              <button
                ...
                className={`px-5 py-2 rounded-md font-mono text-sm transition-colors flex items-center gap-2 ${
                  annual
                    ? "bg-terminal-green text-terminal-black font-bold"
                    : "text-terminal-muted hover:text-terminal-text"
                }`}
                ...
                >
                  ...
                  {planKey !== null ? (
                    <button
                      ...
                      className={`inline-flex items-center justify-center gap-2 w-full px-6 py-3 rounded-md font-mono text-sm font-bold transition-colors ${
                        isCurrentPlan
                    ...
                    <Link
                      href="/dashboard"
                      className="inline-flex items-center justify-center gap-2 w-full px-6 py-3 rounded-md font-mono text-sm font-bold transition-colors bg-terminal-gray/30 text-terminal-muted border border-terminal-border hover:border-terminal-green hover:text-terminal-green"
                    >
                      Go to Dashboard
                      <ArrowRight className="w-4 h-4" />
                    </Link>
                    ...
                    <div className="space-y-3">
                      <Link
                        ...
                        className="inline-flex items-center justify-center gap-2 w-full px-6 py-3 rounded-md font-mono text-sm font-bold transition-colors border border-terminal-border text-terminal-text hover:border-terminal-green hover:text-terminal-green"
                      >
                        {plan.cta}
                        <ArrowRight className="w-4 h-4" />
                      </Link>
                      {plan.ctaSecondary && plan.ctaSecondaryHref && (
                        <Link
                          ...
                          className="inline-flex items-center justify-center gap-2 w-full px-6 py-3 rounded-md font-mono text-sm transition-colors bg-terminal-green/10 border border-terminal-green/30 text-terminal-green hover:bg-terminal-green/20"
                        >
                          {plan.ctaSecondary}
                          <ArrowRight className="w-4 h-4" />
                        </Link>
          ...
          <div className="text-center card p-12">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <Link
                href="/contact"
                className="inline-flex items-center gap-2 px-6 py-3 border border-terminal-border text-terminal-muted hover:border-terminal-green hover:text-terminal-green font-mono text-sm rounded-md transition-colors"
              >
                Talk to Sales
              </Link>
            </div>
