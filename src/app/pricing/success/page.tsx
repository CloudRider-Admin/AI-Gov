      ...
      <div className="terminal-window glow-green max-w-md w-full text-center">
        ...
        <div className="p-10">
          ...
          <div className="flex flex-col gap-3">
            ...
            <Link
              href="/govi"
              className="inline-flex items-center justify-center gap-2 px-6 py-3 border border-terminal-border text-terminal-muted hover:border-terminal-green hover:text-terminal-green font-mono text-sm rounded-lg transition-colors"
            >
              Try the AI Advisor
            </Link>
          </div>
