    ...
    <>
      <div className="section min-h-screen">
        <div className="max-w-7xl mx-auto">
          ...
          {/* Introduction */}
          <div className="mt-8 mb-12 p-6 bg-terminal-dark/50 border border-terminal-border rounded-xl">
          ...
          <section className="mb-16">
            ...
            <ul className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {level.objectives.map((objective, index) => (
                <li
                  key={index}
                  className="flex items-start gap-3 p-4 border border-terminal-border rounded-xl bg-terminal-gray/30"
                >
                  ...
                  <div className="flex flex-wrap gap-2">
                    {category.topics.slice(0, 4).map((topic) => (
                      <Link
                        ...
                        className="px-3 py-1 text-xs font-mono text-terminal-muted border border-terminal-border rounded-md hover:border-terminal-green hover:text-terminal-green transition-colors"
                      >
                        {topic.title}
                      </Link>
                    ))}
