      ...
      {isHovered && (
        ...
        >
          <div style={{ transform: 'scale(0.9)', transformOrigin: 'bottom center' }}>
            <div
              className="bg-black/90 backdrop-blur-md border rounded-lg shadow-2xl"
              style={{
            ...
            >
              <div
                ...
                style={{ color: point.color, fontSize: '10px', letterSpacing: '0.4px' }}
              >
                {point.label}
              </div>
              <div
                className="font-mono mt-1 leading-snug"
              ...
              <div
                ...
                style={{ color: point.color, fontSize: '8.5px', opacity: 0.85 }}
              >
                → Explore
              </div>
            </div>
        ...
        {legendEntries.map(([cat, cfg]) => {
          ...
          return (
            <button
              ...
              className="px-2.5 py-0.5 rounded text-[10px] font-mono border transition-all duration-200"
              style={{
