    ...
    <nav className="flex flex-col sm:flex-row items-stretch gap-4 mt-12 pt-8 border-t border-terminal-border">
      ...
      <div className="flex-1">
        {previous && (
          <Link
            href={previous.href}
            className="group flex items-center gap-3 p-4 border border-terminal-border rounded-lg hover:border-terminal-green/50 transition-colors h-full"
          >
      ...
      <div className="flex-1">
        {next && (
          <Link
            href={next.href}
            className="group flex items-center justify-end gap-3 p-4 border border-terminal-border rounded-lg hover:border-terminal-green/50 transition-colors h-full text-right"
          >
            <div className="min-w-0">
              <div className="text-xs font-mono text-terminal-muted uppercase tracking-wider mb-1">
                Next
