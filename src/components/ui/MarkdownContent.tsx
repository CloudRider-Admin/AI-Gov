...
const components: Components = {
  ...
  pre: ({ children }) => (
    <pre className="bg-terminal-gray border border-terminal-border rounded-lg p-4 my-4 overflow-x-auto font-mono text-sm">
      {children}
    </pre>
  ),
  code: ({ children, className }) => {
    ...
    return (
      <code className="bg-terminal-gray px-2 py-0.5 rounded text-terminal-green font-mono text-sm">
        {children}
      </code>
    );
  },
