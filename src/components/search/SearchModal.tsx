  ...
  return (
    <>
      ...
      <div className="fixed top-[20%] left-1/2 -translate-x-1/2 w-full max-w-2xl z-50 px-4">
        <div className="bg-terminal-dark border border-terminal-border rounded-lg shadow-2xl overflow-hidden">
          {/* Search input */}
          ...
          <div className="max-h-[60vh] overflow-y-auto">
            {query.length < 2 ? (
              <div className="px-4 py-8 text-center">
                ...
                <p className="text-terminal-muted/60 text-xs font-mono mt-2">
                  Press <kbd className="px-1.5 py-0.5 bg-terminal-gray rounded text-terminal-text">Esc</kbd> to close
                </p>
              </div>
            ) : results.length === 0 ? (
              <div className="px-4 py-8 text-center">
                ...
                {results.map((result, index) => {
                  ...
                  return (
                    <li key={`${result.type}-${result.id}`}>
                      ...
                      >
                        <div
                          className={`w-8 h-8 flex items-center justify-center rounded border flex-shrink-0 ${
                            isSelected
                        ...
                        <div className="flex-grow min-w-0">
                          ...
                          <div className="flex items-center gap-2 mt-1">
                            <span className="text-xs font-mono text-terminal-muted/60">
          ...
          <div className="px-4 py-2 border-t border-terminal-border bg-terminal-gray/30 flex items-center justify-between text-xs font-mono text-terminal-muted">
            <div className="flex items-center gap-4">
              <span className="flex items-center gap-1">
                <kbd className="px-1.5 py-0.5 bg-terminal-gray rounded text-terminal-text">↑</kbd>
                <kbd className="px-1.5 py-0.5 bg-terminal-gray rounded text-terminal-text">↓</kbd>
            ...
            <span className="flex items-center gap-1">
              <kbd className="px-1.5 py-0.5 bg-terminal-gray rounded text-terminal-text">Esc</kbd>
