...
export function VisualGuides() {
  ...
  // Hide the section entirely when no guides have attached imagery yet —
  // avoids rendering an orphaned header above an empty list.
  if (guidesWithImages.length === 0) return null;
